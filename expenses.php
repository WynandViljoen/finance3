...
<?php
	...
	echo "<br><b>List of all expense transfers from $mydate-01 to $mydatet <a href=\"expensesAll.php\">(View Entire History)</a><br>";
	echo "</div>";

	$sql = "SELECT * FROM `txexpense` WHERE `Date` LIKE '$mydate%' ORDER BY `Date` DESC";
	echo "<table align=center id=\"table2\" class=\"mytable\" border=1><th>Description</th><th>Date</th><th>Amount</th><th>Expense</th><th>Account</th><th>Delete</th>";
	...
	while ($row=mysqli_fetch_row($result))
	{
		...
		echo "<form method=\"post\" action=\"removeexpensetx.php\">";
		...
		echo "<input type=\"hidden\" name=\"expense\" value=\"" . $row['4'] . "\">";
		echo "<input type=\"hidden\" name=\"account\" value=\"" . $row['5'] . "\">";
