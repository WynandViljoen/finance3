...
<?php
	...
	echo "<br><b>List of all income transfers from $mydate-01 to $mydatet <a href=\"incomeAll.php\">(View Entire History)</a><br>";
	echo "</div>";

	$mydate = date("Y-m"); 

	$sql = "SELECT * FROM `txincome` WHERE `Date` LIKE '$mydate%' ORDER BY `Date` DESC";
