...
<?php
	...
	$sql2 = "SELECT DISTINCT `Expense` FROM `expenseview`";
	...
	while ($row2=mysqli_fetch_row($result2))
	{
		...
		$sql = "SELECT `total`, `month` FROM `expenseview` WHERE (`Expense` = '" . $objectId . "') ORDER BY `month` ASC";
...
$(function () {
    ...
    title: {
        text: 'Graph of All Expenses (Total | Average per month)'
    },
